...
import fr.cea.nabla.interpreter.nodes.expression.NablaParenthesisNode;
...
public final class NablaParenthesisNodeGen extends NablaParenthesisNode {
    ...
    public Object executeGeneric(VirtualFrame frameValue) {
        ...
        if ((state & 0b1) != 0 /* is-active executeNV0Bool(VirtualFrame, NV0Bool) */ && expressionValue_ instanceof NV0Bool) {
            NV0Bool expressionValue__ = (NV0Bool) expressionValue_;
            return executeNV0Bool(frameValue, expressionValue__);
        }
        if ((state & 0b10) != 0 /* is-active executeNV0Int(VirtualFrame, NV0Int) */ && expressionValue_ instanceof NV0Int) {
            NV0Int expressionValue__ = (NV0Int) expressionValue_;
            return executeNV0Int(frameValue, expressionValue__);
        }
        if ((state & 0b100) != 0 /* is-active executeNV0Real(VirtualFrame, NV0Real) */ && expressionValue_ instanceof NV0Real) {
            NV0Real expressionValue__ = (NV0Real) expressionValue_;
            return executeNV0Real(frameValue, expressionValue__);
        }
        if ((state & 0b1000) != 0 /* is-active executeNV1Bool(VirtualFrame, NV1Bool) */ && expressionValue_ instanceof NV1Bool) {
            NV1Bool expressionValue__ = (NV1Bool) expressionValue_;
            return executeNV1Bool(frameValue, expressionValue__);
        }
        if ((state & 0b10000) != 0 /* is-active executeNV1Int(VirtualFrame, NV1Int) */ && expressionValue_ instanceof NV1Int) {
            NV1Int expressionValue__ = (NV1Int) expressionValue_;
            return executeNV1Int(frameValue, expressionValue__);
        }
        if ((state & 0b100000) != 0 /* is-active executeNV1Real(VirtualFrame, NV1Real) */ && expressionValue_ instanceof NV1Real) {
            NV1Real expressionValue__ = (NV1Real) expressionValue_;
            return executeNV1Real(frameValue, expressionValue__);
        }
        if ((state & 0b1000000) != 0 /* is-active executeNV2Bool(VirtualFrame, NV2Bool) */ && expressionValue_ instanceof NV2Bool) {
            NV2Bool expressionValue__ = (NV2Bool) expressionValue_;
            return executeNV2Bool(frameValue, expressionValue__);
        }
        if ((state & 0b10000000) != 0 /* is-active executeNV2Int(VirtualFrame, NV2Int) */ && expressionValue_ instanceof NV2Int) {
            NV2Int expressionValue__ = (NV2Int) expressionValue_;
            return executeNV2Int(frameValue, expressionValue__);
        }
        if ((state & 0b100000000) != 0 /* is-active executeNV2Real(VirtualFrame, NV2Real) */ && expressionValue_ instanceof NV2Real) {
            NV2Real expressionValue__ = (NV2Real) expressionValue_;
            return executeNV2Real(frameValue, expressionValue__);
        }
        if ((state & 0b1000000000) != 0 /* is-active executeNV3Int(VirtualFrame, NV3Int) */ && expressionValue_ instanceof NV3Int) {
            NV3Int expressionValue__ = (NV3Int) expressionValue_;
            return executeNV3Int(frameValue, expressionValue__);
        }
        if ((state & 0b10000000000) != 0 /* is-active executeNV3Real(VirtualFrame, NV3Real) */ && expressionValue_ instanceof NV3Real) {
            NV3Real expressionValue__ = (NV3Real) expressionValue_;
            return executeNV3Real(frameValue, expressionValue__);
        }
        if ((state & 0b100000000000) != 0 /* is-active executeNV4Int(VirtualFrame, NV4Int) */ && expressionValue_ instanceof NV4Int) {
            NV4Int expressionValue__ = (NV4Int) expressionValue_;
            return executeNV4Int(frameValue, expressionValue__);
        }
        if ((state & 0b1000000000000) != 0 /* is-active executeNV4Real(VirtualFrame, NV4Real) */ && expressionValue_ instanceof NV4Real) {
    ...
    private Object executeAndSpecialize(VirtualFrame frameValue, Object expressionValue) {
        ...
        if (expressionValue instanceof NV0Bool) {
            ...
            this.state_ = state = state | 0b1 /* add-active executeNV0Bool(VirtualFrame, NV0Bool) */;
        ...
        if (expressionValue instanceof NV0Int) {
            ...
            this.state_ = state = state | 0b10 /* add-active executeNV0Int(VirtualFrame, NV0Int) */;
        ...
        if (expressionValue instanceof NV0Real) {
            ...
            this.state_ = state = state | 0b100 /* add-active executeNV0Real(VirtualFrame, NV0Real) */;
        ...
        if (expressionValue instanceof NV1Bool) {
            ...
            this.state_ = state = state | 0b1000 /* add-active executeNV1Bool(VirtualFrame, NV1Bool) */;
        ...
        if (expressionValue instanceof NV1Int) {
            ...
            this.state_ = state = state | 0b10000 /* add-active executeNV1Int(VirtualFrame, NV1Int) */;
        ...
        if (expressionValue instanceof NV1Real) {
            ...
            this.state_ = state = state | 0b100000 /* add-active executeNV1Real(VirtualFrame, NV1Real) */;
        ...
        if (expressionValue instanceof NV2Bool) {
            ...
            this.state_ = state = state | 0b1000000 /* add-active executeNV2Bool(VirtualFrame, NV2Bool) */;
        ...
        if (expressionValue instanceof NV2Int) {
            ...
            this.state_ = state = state | 0b10000000 /* add-active executeNV2Int(VirtualFrame, NV2Int) */;
        ...
        if (expressionValue instanceof NV2Real) {
            ...
            this.state_ = state = state | 0b100000000 /* add-active executeNV2Real(VirtualFrame, NV2Real) */;
        ...
        if (expressionValue instanceof NV3Int) {
            ...
            this.state_ = state = state | 0b1000000000 /* add-active executeNV3Int(VirtualFrame, NV3Int) */;
        ...
        if (expressionValue instanceof NV3Real) {
            ...
            this.state_ = state = state | 0b10000000000 /* add-active executeNV3Real(VirtualFrame, NV3Real) */;
        ...
        if (expressionValue instanceof NV4Int) {
            ...
            this.state_ = state = state | 0b100000000000 /* add-active executeNV4Int(VirtualFrame, NV4Int) */;
        ...
        if (expressionValue instanceof NV4Real) {
            ...
            this.state_ = state = state | 0b1000000000000 /* add-active executeNV4Real(VirtualFrame, NV4Real) */;
