...
import fr.cea.nabla.interpreter.nodes.expression.NablaExternalMethodCallNode.InvokeMethod;
import java.util.concurrent.locks.Lock;

@GeneratedBy(NablaExternalMethodCallNode.class)
public final class NablaExternalMethodCallNodeFactory {

    private static final LibraryFactory<InteropLibrary> INTEROP_LIBRARY_ = LibraryFactory.resolve(InteropLibrary.class);

    @GeneratedBy(InvokeMethod.class)
    static final class InvokeMethodNodeGen extends InvokeMethod {

        @CompilationFinal private int state_;
        @CompilationFinal private int exclude_;
        @Child private Default0Data default0_cache;

        private InvokeMethodNodeGen() {
        }

        @ExplodeLoop
        @Override
        Object execute(Object arg0Value, String arg1Value, Object[] arg2Value) {
            int state = state_;
        ...
        public static InvokeMethod create() {
            return new InvokeMethodNodeGen();
        }
