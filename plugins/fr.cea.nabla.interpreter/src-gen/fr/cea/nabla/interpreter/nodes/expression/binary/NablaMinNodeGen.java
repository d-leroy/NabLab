...
import fr.cea.nabla.interpreter.nodes.expression.binary.NablaMinNode;
...
public final class NablaMinNodeGen extends NablaMinNode {
    ...
    public Object executeGeneric(VirtualFrame frameValue) {
        ...
        if ((state & 0b11) != 0 /* is-active min(NV0Int, NV0Int) || min(NV0Int, NV0Real) */ && leftNodeValue_ instanceof NV0Int) {
            NV0Int leftNodeValue__ = (NV0Int) leftNodeValue_;
            if ((state & 0b1) != 0 /* is-active min(NV0Int, NV0Int) */ && rightNodeValue_ instanceof NV0Int) {
                NV0Int rightNodeValue__ = (NV0Int) rightNodeValue_;
                return min(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0b10) != 0 /* is-active min(NV0Int, NV0Real) */ && rightNodeValue_ instanceof NV0Real) {
                NV0Real rightNodeValue__ = (NV0Real) rightNodeValue_;
                return min(leftNodeValue__, rightNodeValue__);
            }
        }
        if ((state & 0b1100) != 0 /* is-active min(NV0Real, NV0Int) || min(NV0Real, NV0Real) */ && leftNodeValue_ instanceof NV0Real) {
            NV0Real leftNodeValue__ = (NV0Real) leftNodeValue_;
            if ((state & 0b100) != 0 /* is-active min(NV0Real, NV0Int) */ && rightNodeValue_ instanceof NV0Int) {
                NV0Int rightNodeValue__ = (NV0Int) rightNodeValue_;
                return min(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0b1000) != 0 /* is-active min(NV0Real, NV0Real) */ && rightNodeValue_ instanceof NV0Real) {
                NV0Real rightNodeValue__ = (NV0Real) rightNodeValue_;
                return min(leftNodeValue__, rightNodeValue__);
            }
        }
    ...
    private Object executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
        ...
        if (leftNodeValue instanceof NV0Int) {
            ...
            if (rightNodeValue instanceof NV0Int) {
                ...
                this.state_ = state = state | 0b1 /* add-active min(NV0Int, NV0Int) */;
            ...
            if (rightNodeValue instanceof NV0Real) {
                ...
                this.state_ = state = state | 0b10 /* add-active min(NV0Int, NV0Real) */;
                return min(leftNodeValue_, rightNodeValue_);
            }
        }
        if (leftNodeValue instanceof NV0Real) {
            ...
            if (rightNodeValue instanceof NV0Int) {
                NV0Int rightNodeValue_ = (NV0Int) rightNodeValue;
                this.state_ = state = state | 0b100 /* add-active min(NV0Real, NV0Int) */;
                return min(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV0Real) {
                NV0Real rightNodeValue_ = (NV0Real) rightNodeValue;
                this.state_ = state = state | 0b1000 /* add-active min(NV0Real, NV0Real) */;
                return min(leftNodeValue_, rightNodeValue_);
            }
        }
