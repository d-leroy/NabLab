...
public class CompilationChainHelper {
  ...
  private ParseHelper<NablagenModule> nablagenParseHelper = this.nablagenInjector.<ParseHelper>getInstance(ParseHelper.class);
  ...
  public IrModule getIrModule(final CharSequence model, final CharSequence genModel) {
    try {
      ...
      final String linearAlgebraFunctionsPath = (pluginsPath + "fr.cea.nabla/nablalib/linearalgebrafunctions.nabla");
