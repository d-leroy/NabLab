...
import fr.cea.nabla.ir.truffle.nodes.expression.binary.NablaSubNode;
...
public final class NablaSubNodeGen extends NablaSubNode {
    ...
    public Object executeGeneric(VirtualFrame frameValue) {
        ...
        if ((state & 0b111100000000) != 0 /* is-active sub(NV1Real, NV0Int) || sub(NV1Real, NV0Real) || sub(NV1Real, NV1Int) || sub(NV1Real, NV1Real) */ && leftNodeValue_ instanceof NV1Real) {
            ...
            if ((state & 0b100000000000) != 0 /* is-active sub(NV1Real, NV1Real) */ && rightNodeValue_ instanceof NV1Real) {
                NV1Real rightNodeValue__ = (NV1Real) rightNodeValue_;
                return sub(leftNodeValue__, rightNodeValue__);
            }
        }
        if ((state & 0b111000000000000) != 0 /* is-active sub(NV2Int, NV0Int) || sub(NV2Int, NV0Real) || sub(NV2Int, NV2Int) */ && leftNodeValue_ instanceof NV2Int) {
            NV2Int leftNodeValue__ = (NV2Int) leftNodeValue_;
            if ((state & 0b1000000000000) != 0 /* is-active sub(NV2Int, NV0Int) */ && rightNodeValue_ instanceof NV0Int) {
                NV0Int rightNodeValue__ = (NV0Int) rightNodeValue_;
                return sub(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0b10000000000000) != 0 /* is-active sub(NV2Int, NV0Real) */ && rightNodeValue_ instanceof NV0Real) {
                NV0Real rightNodeValue__ = (NV0Real) rightNodeValue_;
                return sub(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0b100000000000000) != 0 /* is-active sub(NV2Int, NV2Int) */ && rightNodeValue_ instanceof NV2Int) {
                NV2Int rightNodeValue__ = (NV2Int) rightNodeValue_;
                return sub(leftNodeValue__, rightNodeValue__);
            }
        }
        if ((state & 0x38000) != 0 /* is-active sub(NV2Real, NV0Int) || sub(NV2Real, NV0Real) || sub(NV2Real, NV2Real) */ && leftNodeValue_ instanceof NV2Real) {
            NV2Real leftNodeValue__ = (NV2Real) leftNodeValue_;
            if ((state & 0b1000000000000000) != 0 /* is-active sub(NV2Real, NV0Int) */ && rightNodeValue_ instanceof NV0Int) {
                NV0Int rightNodeValue__ = (NV0Int) rightNodeValue_;
                return sub(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0x10000) != 0 /* is-active sub(NV2Real, NV0Real) */ && rightNodeValue_ instanceof NV0Real) {
                NV0Real rightNodeValue__ = (NV0Real) rightNodeValue_;
                return sub(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0x20000) != 0 /* is-active sub(NV2Real, NV2Real) */ && rightNodeValue_ instanceof NV2Real) {
    ...
    private Object executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
        ...
        if (leftNodeValue instanceof NV1Real) {
            ...
            if (rightNodeValue instanceof NV1Real) {
                NV1Real rightNodeValue_ = (NV1Real) rightNodeValue;
                this.state_ = state = state | 0b100000000000 /* add-active sub(NV1Real, NV1Real) */;
                return sub(leftNodeValue_, rightNodeValue_);
            }
        }
        if (leftNodeValue instanceof NV2Int) {
            ...
            if (rightNodeValue instanceof NV0Int) {
                NV0Int rightNodeValue_ = (NV0Int) rightNodeValue;
                this.state_ = state = state | 0b1000000000000 /* add-active sub(NV2Int, NV0Int) */;
                return sub(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV0Real) {
                NV0Real rightNodeValue_ = (NV0Real) rightNodeValue;
                this.state_ = state = state | 0b10000000000000 /* add-active sub(NV2Int, NV0Real) */;
                return sub(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV2Int) {
                NV2Int rightNodeValue_ = (NV2Int) rightNodeValue;
                this.state_ = state = state | 0b100000000000000 /* add-active sub(NV2Int, NV2Int) */;
                return sub(leftNodeValue_, rightNodeValue_);
            }
        }
        if (leftNodeValue instanceof NV2Real) {
            ...
            if (rightNodeValue instanceof NV0Int) {
                NV0Int rightNodeValue_ = (NV0Int) rightNodeValue;
                this.state_ = state = state | 0b1000000000000000 /* add-active sub(NV2Real, NV0Int) */;
                return sub(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV0Real) {
                NV0Real rightNodeValue_ = (NV0Real) rightNodeValue;
                this.state_ = state = state | 0x10000 /* add-active sub(NV2Real, NV0Real) */;
                return sub(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV2Real) {
                NV2Real rightNodeValue_ = (NV2Real) rightNodeValue;
                this.state_ = state = state | 0x20000 /* add-active sub(NV2Real, NV2Real) */;
                return sub(leftNodeValue_, rightNodeValue_);
            }
        }
