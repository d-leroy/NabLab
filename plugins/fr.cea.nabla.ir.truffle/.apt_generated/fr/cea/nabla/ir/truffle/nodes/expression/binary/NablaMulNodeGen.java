...
import fr.cea.nabla.ir.truffle.nodes.expression.binary.NablaMulNode;
...
public final class NablaMulNodeGen extends NablaMulNode {
    ...
    public Object executeGeneric(VirtualFrame frameValue) {
        ...
        if ((state & 0b111111000000) != 0 /* is-active mul(NV0Real, NV0Int) || mul(NV0Real, NV0Real) || mul(NV0Real, NV1Int) || mul(NV0Real, NV1Real) || mul(NV0Real, NV2Int) || mul(NV0Real, NV2Real) */ && leftNodeValue_ instanceof NV0Real) {
            ...
            if ((state & 0b1000000000) != 0 /* is-active mul(NV0Real, NV1Real) */ && rightNodeValue_ instanceof NV1Real) {
                NV1Real rightNodeValue__ = (NV1Real) rightNodeValue_;
                return mul(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0b10000000000) != 0 /* is-active mul(NV0Real, NV2Int) */ && rightNodeValue_ instanceof NV2Int) {
                NV2Int rightNodeValue__ = (NV2Int) rightNodeValue_;
                return mul(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0b100000000000) != 0 /* is-active mul(NV0Real, NV2Real) */ && rightNodeValue_ instanceof NV2Real) {
                NV2Real rightNodeValue__ = (NV2Real) rightNodeValue_;
                return mul(leftNodeValue__, rightNodeValue__);
            }
        }
        if ((state & 0b1111000000000000) != 0 /* is-active mul(NV1Int, NV0Int) || mul(NV1Int, NV0Real) || mul(NV1Int, NV1Int) || mul(NV1Int, NV1Real) */ && leftNodeValue_ instanceof NV1Int) {
            NV1Int leftNodeValue__ = (NV1Int) leftNodeValue_;
            if ((state & 0b1000000000000) != 0 /* is-active mul(NV1Int, NV0Int) */ && rightNodeValue_ instanceof NV0Int) {
                NV0Int rightNodeValue__ = (NV0Int) rightNodeValue_;
                return mul(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0b10000000000000) != 0 /* is-active mul(NV1Int, NV0Real) */ && rightNodeValue_ instanceof NV0Real) {
                NV0Real rightNodeValue__ = (NV0Real) rightNodeValue_;
                return mul(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0b100000000000000) != 0 /* is-active mul(NV1Int, NV1Int) */ && rightNodeValue_ instanceof NV1Int) {
                NV1Int rightNodeValue__ = (NV1Int) rightNodeValue_;
                return mul(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0b1000000000000000) != 0 /* is-active mul(NV1Int, NV1Real) */ && rightNodeValue_ instanceof NV1Real) {
                NV1Real rightNodeValue__ = (NV1Real) rightNodeValue_;
                return mul(leftNodeValue__, rightNodeValue__);
            }
        }
        if ((state & 0xf0000) != 0 /* is-active mul(NV1Real, NV0Int) || mul(NV1Real, NV0Real) || mul(NV1Real, NV1Int) || mul(NV1Real, NV1Real) */ && leftNodeValue_ instanceof NV1Real) {
            NV1Real leftNodeValue__ = (NV1Real) leftNodeValue_;
            if ((state & 0x10000) != 0 /* is-active mul(NV1Real, NV0Int) */ && rightNodeValue_ instanceof NV0Int) {
                NV0Int rightNodeValue__ = (NV0Int) rightNodeValue_;
                return mul(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0x20000) != 0 /* is-active mul(NV1Real, NV0Real) */ && rightNodeValue_ instanceof NV0Real) {
                NV0Real rightNodeValue__ = (NV0Real) rightNodeValue_;
                return mul(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0x40000) != 0 /* is-active mul(NV1Real, NV1Int) */ && rightNodeValue_ instanceof NV1Int) {
                NV1Int rightNodeValue__ = (NV1Int) rightNodeValue_;
                return mul(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0x80000) != 0 /* is-active mul(NV1Real, NV1Real) */ && rightNodeValue_ instanceof NV1Real) {
                NV1Real rightNodeValue__ = (NV1Real) rightNodeValue_;
                return mul(leftNodeValue__, rightNodeValue__);
            }
        }
        if ((state & 0x700000) != 0 /* is-active mul(NV2Int, NV0Int) || mul(NV2Int, NV0Real) || mul(NV2Int, NV2Int) */ && leftNodeValue_ instanceof NV2Int) {
            NV2Int leftNodeValue__ = (NV2Int) leftNodeValue_;
            if ((state & 0x100000) != 0 /* is-active mul(NV2Int, NV0Int) */ && rightNodeValue_ instanceof NV0Int) {
                NV0Int rightNodeValue__ = (NV0Int) rightNodeValue_;
                return mul(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0x200000) != 0 /* is-active mul(NV2Int, NV0Real) */ && rightNodeValue_ instanceof NV0Real) {
                NV0Real rightNodeValue__ = (NV0Real) rightNodeValue_;
                return mul(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0x400000) != 0 /* is-active mul(NV2Int, NV2Int) */ && rightNodeValue_ instanceof NV2Int) {
                NV2Int rightNodeValue__ = (NV2Int) rightNodeValue_;
                return mul(leftNodeValue__, rightNodeValue__);
            }
        }
        if ((state & 0x3800000) != 0 /* is-active mul(NV2Real, NV0Int) || mul(NV2Real, NV0Real) || mul(NV2Real, NV2Real) */ && leftNodeValue_ instanceof NV2Real) {
            NV2Real leftNodeValue__ = (NV2Real) leftNodeValue_;
            if ((state & 0x800000) != 0 /* is-active mul(NV2Real, NV0Int) */ && rightNodeValue_ instanceof NV0Int) {
                NV0Int rightNodeValue__ = (NV0Int) rightNodeValue_;
                return mul(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0x1000000) != 0 /* is-active mul(NV2Real, NV0Real) */ && rightNodeValue_ instanceof NV0Real) {
                NV0Real rightNodeValue__ = (NV0Real) rightNodeValue_;
                return mul(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0x2000000) != 0 /* is-active mul(NV2Real, NV2Real) */ && rightNodeValue_ instanceof NV2Real) {
                NV2Real rightNodeValue__ = (NV2Real) rightNodeValue_;
                return mul(leftNodeValue__, rightNodeValue__);
            }
        }
    ...
    private Object executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
        ...
        if (leftNodeValue instanceof NV0Real) {
            ...
            if (rightNodeValue instanceof NV1Real) {
                NV1Real rightNodeValue_ = (NV1Real) rightNodeValue;
                this.state_ = state = state | 0b1000000000 /* add-active mul(NV0Real, NV1Real) */;
                return mul(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV2Int) {
                NV2Int rightNodeValue_ = (NV2Int) rightNodeValue;
                this.state_ = state = state | 0b10000000000 /* add-active mul(NV0Real, NV2Int) */;
                return mul(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV2Real) {
                NV2Real rightNodeValue_ = (NV2Real) rightNodeValue;
                this.state_ = state = state | 0b100000000000 /* add-active mul(NV0Real, NV2Real) */;
                return mul(leftNodeValue_, rightNodeValue_);
            }
        }
        if (leftNodeValue instanceof NV1Int) {
            ...
            if (rightNodeValue instanceof NV0Int) {
                NV0Int rightNodeValue_ = (NV0Int) rightNodeValue;
                this.state_ = state = state | 0b1000000000000 /* add-active mul(NV1Int, NV0Int) */;
                return mul(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV0Real) {
                NV0Real rightNodeValue_ = (NV0Real) rightNodeValue;
                this.state_ = state = state | 0b10000000000000 /* add-active mul(NV1Int, NV0Real) */;
                return mul(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV1Int) {
                NV1Int rightNodeValue_ = (NV1Int) rightNodeValue;
                this.state_ = state = state | 0b100000000000000 /* add-active mul(NV1Int, NV1Int) */;
                return mul(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV1Real) {
                NV1Real rightNodeValue_ = (NV1Real) rightNodeValue;
                this.state_ = state = state | 0b1000000000000000 /* add-active mul(NV1Int, NV1Real) */;
                return mul(leftNodeValue_, rightNodeValue_);
            }
        }
        if (leftNodeValue instanceof NV1Real) {
            ...
            if (rightNodeValue instanceof NV0Int) {
                NV0Int rightNodeValue_ = (NV0Int) rightNodeValue;
                this.state_ = state = state | 0x10000 /* add-active mul(NV1Real, NV0Int) */;
                return mul(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV0Real) {
                NV0Real rightNodeValue_ = (NV0Real) rightNodeValue;
                this.state_ = state = state | 0x20000 /* add-active mul(NV1Real, NV0Real) */;
                return mul(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV1Int) {
                NV1Int rightNodeValue_ = (NV1Int) rightNodeValue;
                this.state_ = state = state | 0x40000 /* add-active mul(NV1Real, NV1Int) */;
                return mul(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV1Real) {
                NV1Real rightNodeValue_ = (NV1Real) rightNodeValue;
                this.state_ = state = state | 0x80000 /* add-active mul(NV1Real, NV1Real) */;
                return mul(leftNodeValue_, rightNodeValue_);
            }
        }
        if (leftNodeValue instanceof NV2Int) {
            ...
            if (rightNodeValue instanceof NV0Int) {
                NV0Int rightNodeValue_ = (NV0Int) rightNodeValue;
                this.state_ = state = state | 0x100000 /* add-active mul(NV2Int, NV0Int) */;
                return mul(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV0Real) {
                NV0Real rightNodeValue_ = (NV0Real) rightNodeValue;
                this.state_ = state = state | 0x200000 /* add-active mul(NV2Int, NV0Real) */;
                return mul(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV2Int) {
                NV2Int rightNodeValue_ = (NV2Int) rightNodeValue;
                this.state_ = state = state | 0x400000 /* add-active mul(NV2Int, NV2Int) */;
                return mul(leftNodeValue_, rightNodeValue_);
            }
        }
        if (leftNodeValue instanceof NV2Real) {
            ...
            if (rightNodeValue instanceof NV0Int) {
                NV0Int rightNodeValue_ = (NV0Int) rightNodeValue;
                this.state_ = state = state | 0x800000 /* add-active mul(NV2Real, NV0Int) */;
                return mul(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV0Real) {
                NV0Real rightNodeValue_ = (NV0Real) rightNodeValue;
                this.state_ = state = state | 0x1000000 /* add-active mul(NV2Real, NV0Real) */;
                return mul(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV2Real) {
                NV2Real rightNodeValue_ = (NV2Real) rightNodeValue;
                this.state_ = state = state | 0x2000000 /* add-active mul(NV2Real, NV2Real) */;
                return mul(leftNodeValue_, rightNodeValue_);
            }
        }
