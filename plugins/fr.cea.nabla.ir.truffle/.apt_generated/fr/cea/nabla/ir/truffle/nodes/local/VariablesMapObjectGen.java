...
package fr.cea.nabla.ir.truffle.nodes.local;
...
import fr.cea.nabla.ir.truffle.nodes.local.NablaLexicalScope.VariablesMapObject;
    ...
    private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
        ...
        private static final class Cached extends InteropLibrary {
            ...
            public boolean accepts(Object receiver) {
                assert !(receiver instanceof VariablesMapObject) || DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null : "Invalid library export 'fr.cea.nabla.ir.truffle.nodes.local.NablaLexicalScope.VariablesMapObject'. Exported receiver with dynamic dispatch found but not expected.";
