...
import fr.cea.nabla.ir.truffle.runtime.FunctionsObject;
    ...
    private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
        ...
        private static final class Cached extends InteropLibrary {
            ...
            public boolean accepts(Object receiver) {
                assert !(receiver instanceof FunctionsObject) || DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null : "Invalid library export 'fr.cea.nabla.ir.truffle.runtime.FunctionsObject'. Exported receiver with dynamic dispatch found but not expected.";
