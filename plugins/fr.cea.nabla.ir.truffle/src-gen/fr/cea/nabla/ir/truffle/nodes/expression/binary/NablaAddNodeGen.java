...
import fr.cea.nabla.ir.truffle.nodes.expression.binary.NablaAddNode;
...
public final class NablaAddNodeGen extends NablaAddNode {
    ...
    public Object executeGeneric(VirtualFrame frameValue) {
        ...
        if ((state & 0xf0000) != 0 /* is-active add(NV1Real, NV0Int) || add(NV1Real, NV0Real) || add(NV1Real, NV1Int) || add(NV1Real, NV1Real) */ && leftNodeValue_ instanceof NV1Real) {
            ...
            if ((state & 0x80000) != 0 /* is-active add(NV1Real, NV1Real) */ && rightNodeValue_ instanceof NV1Real) {
                NV1Real rightNodeValue__ = (NV1Real) rightNodeValue_;
                return add(leftNodeValue__, rightNodeValue__);
            }
        }
        if ((state & 0x700000) != 0 /* is-active add(NV2Int, NV0Int) || add(NV2Int, NV0Real) || add(NV2Int, NV2Int) */ && leftNodeValue_ instanceof NV2Int) {
            NV2Int leftNodeValue__ = (NV2Int) leftNodeValue_;
            if ((state & 0x100000) != 0 /* is-active add(NV2Int, NV0Int) */ && rightNodeValue_ instanceof NV0Int) {
                NV0Int rightNodeValue__ = (NV0Int) rightNodeValue_;
                return add(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0x200000) != 0 /* is-active add(NV2Int, NV0Real) */ && rightNodeValue_ instanceof NV0Real) {
                NV0Real rightNodeValue__ = (NV0Real) rightNodeValue_;
                return add(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0x400000) != 0 /* is-active add(NV2Int, NV2Int) */ && rightNodeValue_ instanceof NV2Int) {
                NV2Int rightNodeValue__ = (NV2Int) rightNodeValue_;
                return add(leftNodeValue__, rightNodeValue__);
            }
        }
        if ((state & 0x3800000) != 0 /* is-active add(NV2Real, NV0Int) || add(NV2Real, NV0Real) || add(NV2Real, NV2Real) */ && leftNodeValue_ instanceof NV2Real) {
            NV2Real leftNodeValue__ = (NV2Real) leftNodeValue_;
            if ((state & 0x800000) != 0 /* is-active add(NV2Real, NV0Int) */ && rightNodeValue_ instanceof NV0Int) {
                NV0Int rightNodeValue__ = (NV0Int) rightNodeValue_;
                return add(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0x1000000) != 0 /* is-active add(NV2Real, NV0Real) */ && rightNodeValue_ instanceof NV0Real) {
                NV0Real rightNodeValue__ = (NV0Real) rightNodeValue_;
                return add(leftNodeValue__, rightNodeValue__);
            }
            if ((state & 0x2000000) != 0 /* is-active add(NV2Real, NV2Real) */ && rightNodeValue_ instanceof NV2Real) {
                NV2Real rightNodeValue__ = (NV2Real) rightNodeValue_;
                return add(leftNodeValue__, rightNodeValue__);
            }
        }
    ...
    private Object executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
        ...
        if (leftNodeValue instanceof NV1Real) {
            ...
            if (rightNodeValue instanceof NV1Real) {
                NV1Real rightNodeValue_ = (NV1Real) rightNodeValue;
                this.state_ = state = state | 0x80000 /* add-active add(NV1Real, NV1Real) */;
                return add(leftNodeValue_, rightNodeValue_);
            }
        }
        if (leftNodeValue instanceof NV2Int) {
            ...
            if (rightNodeValue instanceof NV0Int) {
                NV0Int rightNodeValue_ = (NV0Int) rightNodeValue;
                this.state_ = state = state | 0x100000 /* add-active add(NV2Int, NV0Int) */;
                return add(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV0Real) {
                NV0Real rightNodeValue_ = (NV0Real) rightNodeValue;
                this.state_ = state = state | 0x200000 /* add-active add(NV2Int, NV0Real) */;
                return add(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV2Int) {
                NV2Int rightNodeValue_ = (NV2Int) rightNodeValue;
                this.state_ = state = state | 0x400000 /* add-active add(NV2Int, NV2Int) */;
                return add(leftNodeValue_, rightNodeValue_);
            }
        }
        if (leftNodeValue instanceof NV2Real) {
            ...
            if (rightNodeValue instanceof NV0Int) {
                NV0Int rightNodeValue_ = (NV0Int) rightNodeValue;
                this.state_ = state = state | 0x800000 /* add-active add(NV2Real, NV0Int) */;
                return add(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV0Real) {
                NV0Real rightNodeValue_ = (NV0Real) rightNodeValue;
                this.state_ = state = state | 0x1000000 /* add-active add(NV2Real, NV0Real) */;
                return add(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV2Real) {
                NV2Real rightNodeValue_ = (NV2Real) rightNodeValue;
                this.state_ = state = state | 0x2000000 /* add-active add(NV2Real, NV2Real) */;
                return add(leftNodeValue_, rightNodeValue_);
            }
        }
