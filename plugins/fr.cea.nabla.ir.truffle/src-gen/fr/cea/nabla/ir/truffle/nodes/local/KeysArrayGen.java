...
import fr.cea.nabla.ir.truffle.nodes.local.NablaLexicalScope.KeysArray;
    ...
    private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
        ...
        private static final class Cached extends InteropLibrary {
            ...
            public boolean accepts(Object receiver) {
                assert !(receiver instanceof KeysArray) || DYNAMIC_DISPATCH_LIBRARY_.getUncached().dispatch(receiver) == null : "Invalid library export 'fr.cea.nabla.ir.truffle.nodes.local.NablaLexicalScope.KeysArray'. Exported receiver with dynamic dispatch found but not expected.";
