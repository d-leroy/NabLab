...
final class NV1RealJavaGen {

    private static final LibraryFactory<DynamicDispatchLibrary> DYNAMIC_DISPATCH_LIBRARY_ = LibraryFactory.resolve(DynamicDispatchLibrary.class);

    static  {
        LibraryExport.register(NV1RealJava.class, new InteropLibraryExports(), new NV1RealLibraryExports());
    }

    private NV1RealJavaGen() {
    }
    ...
    private static final class InteropLibraryExports extends LibraryExport<InteropLibrary> {
        ...
        private InteropLibraryExports() {
            super(InteropLibrary.class, NV1RealJava.class, false);
        }

        @Override
        protected InteropLibrary createUncached(Object receiver) {
            assert receiver instanceof NV1RealJava;
    ...
    private static final class NV1RealLibraryExports extends LibraryExport<NV1RealLibrary> {
        ...
        private NV1RealLibraryExports() {
            super(NV1RealLibrary.class, NV1RealJava.class, false);
        }
