...
public final class NablaLeqNodeGen extends NablaLeqNode {
    ...
    public Object executeGeneric(VirtualFrame frameValue) {
        ...
        if ((state_0 & 0b110) != 0 /* is-state_0 leq(NV0Int, NV0Int) || leq(NV0Int, NV0Real) */ && leftNodeValue_ instanceof NV0Int) {
            NV0Int leftNodeValue__ = (NV0Int) leftNodeValue_;
            if ((state_0 & 0b10) != 0 /* is-state_0 leq(NV0Int, NV0Int) */ && rightNodeValue_ instanceof NV0Int) {
                NV0Int rightNodeValue__ = (NV0Int) rightNodeValue_;
                return leq(leftNodeValue__, rightNodeValue__);
            }
            if ((state_0 & 0b100) != 0 /* is-state_0 leq(NV0Int, NV0Real) */ && rightNodeValue_ instanceof NV0Real) {
                NV0Real rightNodeValue__ = (NV0Real) rightNodeValue_;
                return leq(leftNodeValue__, rightNodeValue__);
            }
        }
        if ((state_0 & 0b11000) != 0 /* is-state_0 leq(NV0Real, NV0Int) || leq(NV0Real, NV0Real) */ && leftNodeValue_ instanceof NV0Real) {
            NV0Real leftNodeValue__ = (NV0Real) leftNodeValue_;
            if ((state_0 & 0b1000) != 0 /* is-state_0 leq(NV0Real, NV0Int) */ && rightNodeValue_ instanceof NV0Int) {
                NV0Int rightNodeValue__ = (NV0Int) rightNodeValue_;
                return leq(leftNodeValue__, rightNodeValue__);
            }
            if ((state_0 & 0b10000) != 0 /* is-state_0 leq(NV0Real, NV0Real) */ && rightNodeValue_ instanceof NV0Real) {
                NV0Real rightNodeValue__ = (NV0Real) rightNodeValue_;
                return leq(leftNodeValue__, rightNodeValue__);
            }
        }
    ...
    private NV0Bool executeAndSpecialize(Object leftNodeValue, Object rightNodeValue) {
        ...
        if (leftNodeValue instanceof NV0Int) {
            ...
            if (rightNodeValue instanceof NV0Int) {
                ...
                this.state_0_ = state_0 = state_0 | 0b10 /* add-state_0 leq(NV0Int, NV0Int) */;
            ...
            if (rightNodeValue instanceof NV0Real) {
                ...
                this.state_0_ = state_0 = state_0 | 0b100 /* add-state_0 leq(NV0Int, NV0Real) */;
                return leq(leftNodeValue_, rightNodeValue_);
            }
        }
        if (leftNodeValue instanceof NV0Real) {
            ...
            if (rightNodeValue instanceof NV0Int) {
                NV0Int rightNodeValue_ = (NV0Int) rightNodeValue;
                this.state_0_ = state_0 = state_0 | 0b1000 /* add-state_0 leq(NV0Real, NV0Int) */;
                return leq(leftNodeValue_, rightNodeValue_);
            }
            if (rightNodeValue instanceof NV0Real) {
                NV0Real rightNodeValue_ = (NV0Real) rightNodeValue;
                this.state_0_ = state_0 = state_0 | 0b10000 /* add-state_0 leq(NV0Real, NV0Real) */;
                return leq(leftNodeValue_, rightNodeValue_);
            }
        }
