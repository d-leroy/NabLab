...
final class NablaReadVariableNodeWrapper extends NablaReadVariableNode implements WrapperNode {

    @Child private NablaReadVariableNode delegateNode;
    @Child private ProbeNode probeNode;

    NablaReadVariableNodeWrapper(NablaReadVariableNode delegateNode, ProbeNode probeNode) {
        this.delegateNode = delegateNode;
        this.probeNode = probeNode;
    }

    @Override
    public NablaReadVariableNode getDelegateNode() {
        return delegateNode;
    }
