...
import fr.cea.nabla.interpreter.nodes.expression.binary.NablaAndNode;
import fr.cea.nabla.interpreter.values.NV0Bool;

@GeneratedBy(NablaAndNode.class)
public final class NablaAndNodeGen extends NablaAndNode {

    @Child private NablaExpressionNode leftNode_;
    @Child private NablaExpressionNode rightNode_;
    @CompilationFinal private int state_;

    private NablaAndNodeGen(NablaExpressionNode leftNode, NablaExpressionNode rightNode) {
    ...
    public static NablaAndNode create(NablaExpressionNode leftNode, NablaExpressionNode rightNode) {
        return new NablaAndNodeGen(leftNode, rightNode);
    }
