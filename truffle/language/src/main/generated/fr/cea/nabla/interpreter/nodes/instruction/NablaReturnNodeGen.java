...
public final class NablaReturnNodeGen extends NablaReturnNode {
    ...
    public Object executeGeneric(VirtualFrame frameValue) {
        ...
        if ((state & 0b1) != 0 /* is-active doReal(NV0Real) */ && valueValue_ instanceof NV0Real) {
            NV0Real valueValue__ = (NV0Real) valueValue_;
            return doReal(valueValue__);
        }
        if ((state & 0b10) != 0 /* is-active doReal1(NV1Real) */ && valueValue_ instanceof NV1Real) {
            NV1Real valueValue__ = (NV1Real) valueValue_;
            return doReal1(valueValue__);
        }
        if ((state & 0b100) != 0 /* is-active doBool(NV0Bool) */ && valueValue_ instanceof NV0Bool) {
            NV0Bool valueValue__ = (NV0Bool) valueValue_;
            return doBool(valueValue__);
        }
        if ((state & 0b1000) != 0 /* is-active doBool1(NV1Bool) */ && valueValue_ instanceof NV1Bool) {
            NV1Bool valueValue__ = (NV1Bool) valueValue_;
            return doBool1(valueValue__);
        }
        if ((state & 0b10000) != 0 /* is-active doBool2(NV2Bool) */ && valueValue_ instanceof NV2Bool) {
            NV2Bool valueValue__ = (NV2Bool) valueValue_;
            return doBool2(valueValue__);
        }
        if ((state & 0b100000) != 0 /* is-active doInt(NV0Int) */ && valueValue_ instanceof NV0Int) {
            NV0Int valueValue__ = (NV0Int) valueValue_;
            return doInt(valueValue__);
        }
        if ((state & 0b1000000) != 0 /* is-active doInt1(NV1Int) */ && valueValue_ instanceof NV1Int) {
            NV1Int valueValue__ = (NV1Int) valueValue_;
            return doInt1(valueValue__);
        }
        if ((state & 0b10000000) != 0 /* is-active doInt2(NV2Int) */ && valueValue_ instanceof NV2Int) {
