...
public final class NablaBool1ConstantNodeGen extends NablaBool1ConstantNode {
    ...
    public Object executeGeneric(VirtualFrame frameValue) {
        ...
        if (state_0 != 0 /* is-state_0 doDefaultCached(VirtualFrame, NV0Bool, NV0Int, int, NV1Bool) || doCached(VirtualFrame, NV0Bool, NV0Int, boolean, int, NV1Bool) */ && valueValue_ instanceof NV0Bool) {
            NV0Bool valueValue__ = (NV0Bool) valueValue_;
            if (sizeValue_ instanceof NV0Int) {
                NV0Int sizeValue__ = (NV0Int) sizeValue_;
                if ((state_0 & 0b1) != 0 /* is-state_0 doDefaultCached(VirtualFrame, NV0Bool, NV0Int, int, NV1Bool) */) {
                ...
                if ((state_0 & 0b10) != 0 /* is-state_0 doCached(VirtualFrame, NV0Bool, NV0Int, boolean, int, NV1Bool) */) {
                    ...
                    if (s1_ == null) {
                        {
                            ...
                            if ((cachedSize__ == sizeValue_.getData()) && (!(valueValue_.isData())) && count1_ < (3)) {
                                ...
                                this.state_0_ = state_0 = state_0 | 0b1 /* add-state_0 doDefaultCached(VirtualFrame, NV0Bool, NV0Int, int, NV1Bool) */;
                            }
                        }
                    }
                    if (s1_ != null) {
                    ...
                    if (s2_ == null) {
                        {
                            ...
                            if ((cachedSize__1 == sizeValue_.getData()) && count2_ < (3)) {
                                ...
                                this.state_0_ = state_0 = state_0 | 0b10 /* add-state_0 doCached(VirtualFrame, NV0Bool, NV0Int, boolean, int, NV1Bool) */;
                            }
                        }
                    }
                    if (s2_ != null) {
