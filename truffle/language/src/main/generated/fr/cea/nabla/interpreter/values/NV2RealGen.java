...
@GeneratedBy(NV2Real.class)
public final class NV2RealGen {

    private static final LibraryFactory<DynamicDispatchLibrary> DYNAMIC_DISPATCH_LIBRARY_ = LibraryFactory.resolve(DynamicDispatchLibrary.class);

    static  {
        LibraryExport.register(NV2Real.class, new InteropLibraryExports());
    }
    ...
    public static class InteropLibraryExports extends LibraryExport<InteropLibrary> {
        ...
        private InteropLibraryExports() {
            super(InteropLibrary.class, NV2Real.class, false);
        }

        @Override
        protected InteropLibrary createUncached(Object receiver) {
            assert receiver instanceof NV2Real;
        ...
        public static class Cached extends InteropLibrary {
            ...
            private final Class<? extends NV2Real> receiverClass_;

            protected Cached(Object receiver) {
                NV2Real castReceiver = ((NV2Real) receiver) ;
        ...
        public static class Uncached extends InteropLibrary {
            ...
            protected Uncached(Object receiver) {
                this.receiverClass_ = ((NV2Real) receiver).getClass();
            }
            ...
            public boolean hasArrayElements(Object receiver) {
                // declared: true
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                return ((NV2Real) receiver) .hasArrayElements();
            }
            ...
            public long getArraySize(Object receiver) throws UnsupportedMessageException {
                // declared: true
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                return ((NV2Real) receiver) .getArraySize();
            }
            ...
            public boolean isArrayElementReadable(Object receiver, long index) {
                // declared: true
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                return ((NV2Real) receiver) .isArrayElementReadable(index);
            }
            ...
            public Object readArrayElement(Object receiver, long index) throws UnsupportedMessageException, InvalidArrayIndexException {
                // declared: true
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                return ((NV2Real) receiver) .readArrayElement(index);
            }
            ...
            public boolean hasLanguage(Object receiver) {
                // declared: true
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                return ((NV2Real) receiver) .hasLanguage();
            }
            ...
            public Class<? extends TruffleLanguage<?>> getLanguage(Object receiver) throws UnsupportedMessageException {
                // declared: true
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                return ((NV2Real) receiver) .getLanguage();
            }
            ...
            public boolean hasMetaObject(Object receiver) {
                // declared: true
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                return ((NV2Real) receiver) .hasMetaObject();
            }
            ...
            public Object getMetaObject(Object receiver) throws UnsupportedMessageException {
                // declared: true
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                return ((NV2Real) receiver) .getMetaObject();
            }
            ...
            public Object toDisplayString(Object receiver, boolean allowSideEffects) {
                // declared: true
                assert this.accepts(receiver) : "Invalid library usage. Library does not accept given receiver.";
                return ((NV2Real) receiver) .toDisplayString(allowSideEffects);
            }
