...
public final class CreateNablaValueNodeGen extends CreateNablaValueNode {
    ...
    public NablaValue execute(Object arg0Value) {
        int state = state_;
        if ((state & 0b1) != 0 /* is-active createNablaValue(NablaValue) */ && arg0Value instanceof NablaValue) {
            NablaValue arg0Value_ = (NablaValue) arg0Value;
        ...
        if ((state & 0b1000) != 0 /* is-active createNablaValue(boolean[][]) */ && arg0Value instanceof boolean[][]) {
            boolean[][] arg0Value_ = (boolean[][]) arg0Value;
            return createNablaValue(arg0Value_);
        }
        if ((state & 0b10000) != 0 /* is-active createNablaValue(Integer) */ && arg0Value instanceof Integer) {
        ...
        if ((state & 0b1000000) != 0 /* is-active createNablaValue(Value) */ && arg0Value instanceof Value) {
            Value arg0Value_ = (Value) arg0Value;
            if ((arg0Value_.isNativePointer()) && (arg0Value_.hasArrayElements())) {
                return createNablaValue(arg0Value_);
            }
        }
        if ((state & 0b10000000) != 0 /* is-active createNablaValue(int[][]) */ && arg0Value instanceof int[][]) {
            int[][] arg0Value_ = (int[][]) arg0Value;
            return createNablaValue(arg0Value_);
        }
        ...
        if ((state & 0b1000000000) != 0 /* is-active createNablaValue(double[]) */ && arg0Value instanceof double[]) {
            double[] arg0Value_ = (double[]) arg0Value;
            return createNablaValue(arg0Value_);
        }
        if ((state & 0b10000000000) != 0 /* is-active createNablaValue(double[][]) */ && arg0Value instanceof double[][]) {
            double[][] arg0Value_ = (double[][]) arg0Value;
            return createNablaValue(arg0Value_);
        }
    ...
    private NablaValue executeAndSpecialize(Object arg0Value) {
        int state = state_;
        if (arg0Value instanceof NablaValue) {
            NablaValue arg0Value_ = (NablaValue) arg0Value;
        ...
        if (arg0Value instanceof Integer) {
            Integer arg0Value_ = (Integer) arg0Value;
            this.state_ = state = state | 0b10000 /* add-active createNablaValue(Integer) */;
            return createNablaValue(arg0Value_);
        }
        ...
        if (arg0Value instanceof Value) {
            Value arg0Value_ = (Value) arg0Value;
            if ((arg0Value_.isNativePointer()) && (arg0Value_.hasArrayElements())) {
                this.state_ = state = state | 0b1000000 /* add-active createNablaValue(Value) */;
                return createNablaValue(arg0Value_);
            }
        }
        if (arg0Value instanceof int[][]) {
            int[][] arg0Value_ = (int[][]) arg0Value;
            this.state_ = state = state | 0b10000000 /* add-active createNablaValue(int[][]) */;
            return createNablaValue(arg0Value_);
        }
        ...
        if (arg0Value instanceof double[]) {
            double[] arg0Value_ = (double[]) arg0Value;
            this.state_ = state = state | 0b1000000000 /* add-active createNablaValue(double[]) */;
            return createNablaValue(arg0Value_);
        }
        if (arg0Value instanceof double[][]) {
            double[][] arg0Value_ = (double[][]) arg0Value;
            this.state_ = state = state | 0b10000000000 /* add-active createNablaValue(double[][]) */;
            return createNablaValue(arg0Value_);
        }
