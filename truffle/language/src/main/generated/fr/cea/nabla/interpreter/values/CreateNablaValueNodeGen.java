...
public final class CreateNablaValueNodeGen extends CreateNablaValueNode {
    ...
    public Object executeGeneric(VirtualFrame frameValue) {
        ...
        if ((state_0 & 0b11110) != 0 /* is-state_0 doHostObjectValueDouble1(Value) || doHostObjectValueDouble2(Value) || doHostObjectValueInt1(Value) || doHostObjectValueInt2(Value) */ && expressionValue_ instanceof Value) {
            Value expressionValue__ = (Value) expressionValue_;
            if ((state_0 & 0b10) != 0 /* is-state_0 doHostObjectValueDouble1(Value) */) {
                if ((expressionValue__.isHostObject())) {
                    assert (expectsDouble1());
                    return doHostObjectValueDouble1(expressionValue__);
                }
            }
            if ((state_0 & 0b100) != 0 /* is-state_0 doHostObjectValueDouble2(Value) */) {
                if ((expressionValue__.isHostObject())) {
                    assert (expectsDouble2());
                    return doHostObjectValueDouble2(expressionValue__);
                }
            }
            if ((state_0 & 0b1000) != 0 /* is-state_0 doHostObjectValueInt1(Value) */) {
                if ((expressionValue__.isHostObject())) {
                    assert (expectsInt1());
                    return doHostObjectValueInt1(expressionValue__);
                }
            }
            if ((state_0 & 0b10000) != 0 /* is-state_0 doHostObjectValueInt2(Value) */) {
                if ((expressionValue__.isHostObject())) {
                    assert (expectsInt2());
                    return doHostObjectValueInt2(expressionValue__);
                }
            }
        }
        if ((state_0 & 0b100000) != 0 /* is-state_0 doHostObject(Object, NablaContext, Env) */) {
            HostObjectData s6_ = this.hostObject_cache;
            while (s6_ != null) {
                {
                    ...
                    if ((s6_.env_.isHostObject(expressionValue_))) {
                        return doHostObject(expressionValue_, context__, s6_.env_);
                    }
                }
                s6_ = s6_.next_;
            }
        }
        if ((state_0 & 0b1000000) != 0 /* is-state_0 createNablaValue(Boolean) */ && expressionValue_ instanceof Boolean) {
            Boolean expressionValue__ = (Boolean) expressionValue_;
            return createNablaValue(expressionValue__);
        }
        if ((state_0 & 0b10000000) != 0 /* is-state_0 createNablaValue(boolean[]) */ && expressionValue_ instanceof boolean[]) {
            boolean[] expressionValue__ = (boolean[]) expressionValue_;
            return createNablaValue(expressionValue__);
        }
        if ((state_0 & 0b100000000) != 0 /* is-state_0 createNablaValue(boolean[][]) */ && expressionValue_ instanceof boolean[][]) {
            boolean[][] expressionValue__ = (boolean[][]) expressionValue_;
            return createNablaValue(expressionValue__);
        }
        if ((state_0 & 0b1000000000) != 0 /* is-state_0 createNablaValue(Integer) */ && expressionValue_ instanceof Integer) {
            Integer expressionValue__ = (Integer) expressionValue_;
            return createNablaValue(expressionValue__);
        }
        if ((state_0 & 0b10000000000) != 0 /* is-state_0 createNablaValue(Long) */ && expressionValue_ instanceof Long) {
            Long expressionValue__ = (Long) expressionValue_;
            return createNablaValue(expressionValue__);
        }
        if ((state_0 & 0b100000000000) != 0 /* is-state_0 createNablaValue(Value) */ && expressionValue_ instanceof Value) {
            Value expressionValue__ = (Value) expressionValue_;
        ...
        if ((state_0 & 0b10000000000000) != 0 /* is-state_0 createNablaValueInt1(Value, boolean, boolean, boolean) */ && expressionValue_ instanceof Value) {
            Value expressionValue__ = (Value) expressionValue_;
        ...
        if ((state_0 & 0b100000000000000) != 0 /* is-state_0 createNablaValueInt1(Object, InteropLibrary) */) {
            assert (expectsInt1());
        ...
        if ((state_0 & 0b1000000000000000) != 0 /* is-state_0 createNablaValue(int[][]) */ && expressionValue_ instanceof int[][]) {
            int[][] expressionValue__ = (int[][]) expressionValue_;
            return createNablaValue(expressionValue__);
        }
        if ((state_0 & 0x10000) != 0 /* is-state_0 createNablaValue(Double) */ && expressionValue_ instanceof Double) {
        ...
        if ((state_0 & 0x40000) != 0 /* is-state_0 createNablaValueDouble1(Value) */ && expressionValue_ instanceof Value) {
            Value expressionValue__ = (Value) expressionValue_;
            assert (expectsDouble1());
        ...
        if ((state_0 & 0x80000) != 0 /* is-state_0 createNablaValueDouble1(Object, InteropLibrary) */) {
            assert (expectsDouble1());
        ...
        if ((state_0 & 0x100000) != 0 /* is-state_0 createNablaValue(double[][]) */ && expressionValue_ instanceof double[][]) {
            double[][] expressionValue__ = (double[][]) expressionValue_;
            return createNablaValue(expressionValue__);
        }
    ...
    private Object executeAndSpecialize(Object expressionValue) {
        ...
        try {
            ...
            if (expressionValue instanceof Value) {
                ...
                if ((expressionValue_.isHostObject()) && (expectsDouble1())) {
                    this.state_0_ = state_0 = state_0 | 0b10 /* add-state_0 doHostObjectValueDouble1(Value) */;
                    lock.unlock();
                    hasLock = false;
                    return doHostObjectValueDouble1(expressionValue_);
                }
                if ((expressionValue_.isHostObject()) && (expectsDouble2())) {
                    this.state_0_ = state_0 = state_0 | 0b100 /* add-state_0 doHostObjectValueDouble2(Value) */;
                    lock.unlock();
                    hasLock = false;
                    return doHostObjectValueDouble2(expressionValue_);
                }
                if ((expressionValue_.isHostObject()) && (expectsInt1())) {
                    this.state_0_ = state_0 = state_0 | 0b1000 /* add-state_0 doHostObjectValueInt1(Value) */;
                    lock.unlock();
                    hasLock = false;
                    return doHostObjectValueInt1(expressionValue_);
                }
                if ((expressionValue_.isHostObject()) && (expectsInt2())) {
                    this.state_0_ = state_0 = state_0 | 0b10000 /* add-state_0 doHostObjectValueInt2(Value) */;
                    lock.unlock();
                    hasLock = false;
                    return doHostObjectValueInt2(expressionValue_);
                }
            }
            {
                    ...
                    while (s6_ != null) {
                        {
                            ...
                            if ((s6_.env_.isHostObject(expressionValue))) {
                                break;
                            }
                        }
                        s6_ = s6_.next_;
                ...
                if (s6_ == null) {
                    {
                        ...
                        if ((env__.isHostObject(expressionValue)) && count6_ < (3)) {
                            s6_ = new HostObjectData(hostObject_cache);
                            s6_.env_ = env__;
                            this.hostObject_cache = s6_;
                            this.state_0_ = state_0 = state_0 | 0b100000 /* add-state_0 doHostObject(Object, NablaContext, Env) */;
                        }
                    }
                }
                if (s6_ != null) {
                    lock.unlock();
                    hasLock = false;
                    return doHostObject(expressionValue, context__, s6_.env_);
                }
            }
            if (expressionValue instanceof Boolean) {
                Boolean expressionValue_ = (Boolean) expressionValue;
                this.state_0_ = state_0 = state_0 | 0b1000000 /* add-state_0 createNablaValue(Boolean) */;
                lock.unlock();
                hasLock = false;
                return createNablaValue(expressionValue_);
            }
            if (expressionValue instanceof boolean[]) {
                boolean[] expressionValue_ = (boolean[]) expressionValue;
                this.state_0_ = state_0 = state_0 | 0b10000000 /* add-state_0 createNablaValue(boolean[]) */;
                lock.unlock();
                hasLock = false;
                return createNablaValue(expressionValue_);
            }
            if (expressionValue instanceof boolean[][]) {
                boolean[][] expressionValue_ = (boolean[][]) expressionValue;
                this.state_0_ = state_0 = state_0 | 0b100000000 /* add-state_0 createNablaValue(boolean[][]) */;
                lock.unlock();
                hasLock = false;
                return createNablaValue(expressionValue_);
            }
            if (expressionValue instanceof Integer) {
                ...
                this.state_0_ = state_0 = state_0 | 0b1000000000 /* add-state_0 createNablaValue(Integer) */;
                lock.unlock();
                hasLock = false;
                return createNablaValue(expressionValue_);
            }
            if (expressionValue instanceof Long) {
                ...
                this.state_0_ = state_0 = state_0 | 0b10000000000 /* add-state_0 createNablaValue(Long) */;
                lock.unlock();
                hasLock = false;
                return createNablaValue(expressionValue_);
            }
            if (expressionValue instanceof Value) {
                ...
                if ((expressionValue_.fitsInInt())) {
                    this.state_0_ = state_0 = state_0 | 0b100000000000 /* add-state_0 createNablaValue(Value) */;
                    lock.unlock();
                    hasLock = false;
                    return createNablaValue(expressionValue_);
                }
                    ...
                    if ((createNablaValueInt10_expectsInt1__)) {
                        ...
                        if ((createNablaValueInt10_nativePointer__)) {
                            ...
                            if ((createNablaValueInt10_isArray__)) {
                                ...
                                this.state_0_ = state_0 = state_0 | 0b10000000000000 /* add-state_0 createNablaValueInt1(Value, boolean, boolean, boolean) */;
                                lock.unlock();
                                hasLock = false;
            ...
            if ((expectsInt1())) {
                ...
                if ((createNablaValueInt11_pointers__.isPointer(expressionValue)) && (createNablaValueInt11_pointers__.hasArrayElements(expressionValue))) {
                    ...
                    this.state_0_ = state_0 = state_0 | 0b100000000000000 /* add-state_0 createNablaValueInt1(Object, InteropLibrary) */;
                    lock.unlock();
                    hasLock = false;
            ...
            if (expressionValue instanceof int[][]) {
                int[][] expressionValue_ = (int[][]) expressionValue;
                this.state_0_ = state_0 = state_0 | 0b1000000000000000 /* add-state_0 createNablaValue(int[][]) */;
                lock.unlock();
                hasLock = false;
                return createNablaValue(expressionValue_);
            }
            if (expressionValue instanceof Double) {
                ...
                this.state_0_ = state_0 = state_0 | 0x10000 /* add-state_0 createNablaValue(Double) */;
                lock.unlock();
                hasLock = false;
                return createNablaValue(expressionValue_);
            }
            ...
            if (expressionValue instanceof Value) {
                ...
                if ((expectsDouble1()) && (expressionValue_.isNativePointer()) && (expressionValue_.hasArrayElements())) {
                    this.state_0_ = state_0 = state_0 | 0x40000 /* add-state_0 createNablaValueDouble1(Value) */;
                    lock.unlock();
                    hasLock = false;
            ...
            if ((expectsDouble1())) {
                ...
                if ((createNablaValueDouble11_pointers__.isPointer(expressionValue)) && (createNablaValueDouble11_pointers__.hasArrayElements(expressionValue))) {
                    ...
                    this.state_0_ = state_0 = state_0 | 0x80000 /* add-state_0 createNablaValueDouble1(Object, InteropLibrary) */;
                    lock.unlock();
                    hasLock = false;
            ...
            if (expressionValue instanceof double[][]) {
                double[][] expressionValue_ = (double[][]) expressionValue;
                this.state_0_ = state_0 = state_0 | 0x100000 /* add-state_0 createNablaValue(double[][]) */;
                lock.unlock();
                hasLock = false;
                return createNablaValue(expressionValue_);
            }
