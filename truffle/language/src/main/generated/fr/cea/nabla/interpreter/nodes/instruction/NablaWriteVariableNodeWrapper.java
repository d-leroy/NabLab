...
final class NablaWriteVariableNodeWrapper extends NablaWriteVariableNode implements WrapperNode {
    ...
    @Child private NablaWriteVariableNode delegateNode;
    @Child private ProbeNode probeNode;

    NablaWriteVariableNodeWrapper(NablaWriteVariableNode delegateNode, ProbeNode probeNode) {
        this.delegateNode = delegateNode;
        this.probeNode = probeNode;
    }

    @Override
    public NablaWriteVariableNode getDelegateNode() {
        return delegateNode;
    }
