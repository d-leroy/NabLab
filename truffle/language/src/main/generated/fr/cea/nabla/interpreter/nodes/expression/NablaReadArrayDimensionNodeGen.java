...
public final class NablaReadArrayDimensionNodeGen extends NablaReadArrayDimensionNode {
    ...
    public Object executeGeneric(VirtualFrame frameValue) {
        ...
        if ((state & 0b1) != 0 /* is-active readDimension(VirtualFrame, NV1Bool) */ && arrayValue_ instanceof NV1Bool) {
            NV1Bool arrayValue__ = (NV1Bool) arrayValue_;
            return readDimension(frameValue, arrayValue__);
        }
        if ((state & 0b10) != 0 /* is-active readDimension(VirtualFrame, NV2Bool) */ && arrayValue_ instanceof NV2Bool) {
            NV2Bool arrayValue__ = (NV2Bool) arrayValue_;
            return readDimension(frameValue, arrayValue__);
        }
        if ((state & 0b100) != 0 /* is-active readDimension(VirtualFrame, NV3Bool) */ && arrayValue_ instanceof NV3Bool) {
            NV3Bool arrayValue__ = (NV3Bool) arrayValue_;
            return readDimension(frameValue, arrayValue__);
        }
        if ((state & 0b1000) != 0 /* is-active readDimension(VirtualFrame, NV4Bool) */ && arrayValue_ instanceof NV4Bool) {
            NV4Bool arrayValue__ = (NV4Bool) arrayValue_;
            return readDimension(frameValue, arrayValue__);
        }
        if ((state & 0b10000) != 0 /* is-active readDimension(VirtualFrame, NV1Int) */ && arrayValue_ instanceof NV1Int) {
            NV1Int arrayValue__ = (NV1Int) arrayValue_;
            return readDimension(frameValue, arrayValue__);
        }
        if ((state & 0b100000) != 0 /* is-active readDimension(VirtualFrame, NV2Int) */ && arrayValue_ instanceof NV2Int) {
            NV2Int arrayValue__ = (NV2Int) arrayValue_;
            return readDimension(frameValue, arrayValue__);
        }
        if ((state & 0b1000000) != 0 /* is-active readDimension(VirtualFrame, NV3Int) */ && arrayValue_ instanceof NV3Int) {
            NV3Int arrayValue__ = (NV3Int) arrayValue_;
            return readDimension(frameValue, arrayValue__);
        }
        if ((state & 0b10000000) != 0 /* is-active readDimension(VirtualFrame, NV4Int) */ && arrayValue_ instanceof NV4Int) {
            NV4Int arrayValue__ = (NV4Int) arrayValue_;
            return readDimension(frameValue, arrayValue__);
        }
        if ((state & 0b100000000) != 0 /* is-active readDimension(VirtualFrame, NV1Real) */ && arrayValue_ instanceof NV1Real) {
            NV1Real arrayValue__ = (NV1Real) arrayValue_;
            return readDimension(frameValue, arrayValue__);
        }
        if ((state & 0b1000000000) != 0 /* is-active readDimension(VirtualFrame, NV2Real) */ && arrayValue_ instanceof NV2Real) {
            NV2Real arrayValue__ = (NV2Real) arrayValue_;
            return readDimension(frameValue, arrayValue__);
        }
        if ((state & 0b10000000000) != 0 /* is-active readDimension(VirtualFrame, NV3Real) */ && arrayValue_ instanceof NV3Real) {
            NV3Real arrayValue__ = (NV3Real) arrayValue_;
            return readDimension(frameValue, arrayValue__);
        }
        if ((state & 0b100000000000) != 0 /* is-active readDimension(VirtualFrame, NV4Real) */ && arrayValue_ instanceof NV4Real) {
            NV4Real arrayValue__ = (NV4Real) arrayValue_;
            return readDimension(frameValue, arrayValue__);
        }
        if ((state & 0b1000000000000) != 0 /* is-active readDimension(VirtualFrame, NablaValue) */ && arrayValue_ instanceof NablaValue) {
    ...
    private NV0Int executeAndSpecialize(VirtualFrame frameValue, Object arrayValue) {
        ...
        if (arrayValue instanceof NV1Bool) {
            ...
            this.state_ = state = state | 0b1 /* add-active readDimension(VirtualFrame, NV1Bool) */;
            return readDimension(frameValue, arrayValue_);
        }
        if (arrayValue instanceof NV2Bool) {
            NV2Bool arrayValue_ = (NV2Bool) arrayValue;
            this.state_ = state = state | 0b10 /* add-active readDimension(VirtualFrame, NV2Bool) */;
            return readDimension(frameValue, arrayValue_);
        }
        if (arrayValue instanceof NV3Bool) {
            NV3Bool arrayValue_ = (NV3Bool) arrayValue;
            this.state_ = state = state | 0b100 /* add-active readDimension(VirtualFrame, NV3Bool) */;
            return readDimension(frameValue, arrayValue_);
        }
        if (arrayValue instanceof NV4Bool) {
            NV4Bool arrayValue_ = (NV4Bool) arrayValue;
            this.state_ = state = state | 0b1000 /* add-active readDimension(VirtualFrame, NV4Bool) */;
            return readDimension(frameValue, arrayValue_);
        }
        if (arrayValue instanceof NV1Int) {
            NV1Int arrayValue_ = (NV1Int) arrayValue;
            this.state_ = state = state | 0b10000 /* add-active readDimension(VirtualFrame, NV1Int) */;
            return readDimension(frameValue, arrayValue_);
        }
        if (arrayValue instanceof NV2Int) {
            NV2Int arrayValue_ = (NV2Int) arrayValue;
            this.state_ = state = state | 0b100000 /* add-active readDimension(VirtualFrame, NV2Int) */;
            return readDimension(frameValue, arrayValue_);
        }
        if (arrayValue instanceof NV3Int) {
            NV3Int arrayValue_ = (NV3Int) arrayValue;
            this.state_ = state = state | 0b1000000 /* add-active readDimension(VirtualFrame, NV3Int) */;
            return readDimension(frameValue, arrayValue_);
        }
        if (arrayValue instanceof NV4Int) {
            NV4Int arrayValue_ = (NV4Int) arrayValue;
            this.state_ = state = state | 0b10000000 /* add-active readDimension(VirtualFrame, NV4Int) */;
            return readDimension(frameValue, arrayValue_);
        }
        if (arrayValue instanceof NV1Real) {
            NV1Real arrayValue_ = (NV1Real) arrayValue;
            this.state_ = state = state | 0b100000000 /* add-active readDimension(VirtualFrame, NV1Real) */;
            return readDimension(frameValue, arrayValue_);
        }
        if (arrayValue instanceof NV2Real) {
            NV2Real arrayValue_ = (NV2Real) arrayValue;
            this.state_ = state = state | 0b1000000000 /* add-active readDimension(VirtualFrame, NV2Real) */;
            return readDimension(frameValue, arrayValue_);
        }
        if (arrayValue instanceof NV3Real) {
            NV3Real arrayValue_ = (NV3Real) arrayValue;
            this.state_ = state = state | 0b10000000000 /* add-active readDimension(VirtualFrame, NV3Real) */;
            return readDimension(frameValue, arrayValue_);
        }
        if (arrayValue instanceof NV4Real) {
            NV4Real arrayValue_ = (NV4Real) arrayValue;
            this.state_ = state = state | 0b100000000000 /* add-active readDimension(VirtualFrame, NV4Real) */;
            return readDimension(frameValue, arrayValue_);
        }
        if (arrayValue instanceof NablaValue) {
            NablaValue arrayValue_ = (NablaValue) arrayValue;
            this.state_ = state = state | 0b1000000000000 /* add-active readDimension(VirtualFrame, NablaValue) */;
            return readDimension(frameValue, arrayValue_);
        }
