...
public final class NablaAbsNodeGen extends NablaAbsNode {
    ...
    public Object executeGeneric(VirtualFrame frameValue) {
        ...
        if ((state & 0b111100) != 0 /* is-active abs(Object, NV1IntLibrary) || abs(Object, NV1IntLibrary) || abs(Object, NV1RealLibrary) || abs(Object, NV1RealLibrary) */) {
            ...
            if ((state & 0b10000) != 0 /* is-active abs(Object, NV1RealLibrary) */) {
            ...
            if ((state & 0b100000) != 0 /* is-active abs(Object, NV1RealLibrary) */) {
                EncapsulatingNodeReference encapsulating_ = EncapsulatingNodeReference.getCurrent();
                Node prev_ = encapsulating_.set(this);
                try {
                    {
        ...
        if ((state & 0b1000000) != 0 /* is-active abs(NV2Int) */ && valueNodeValue_ instanceof NV2Int) {
            NV2Int valueNodeValue__ = (NV2Int) valueNodeValue_;
            return abs(valueNodeValue__);
        }
        if ((state & 0b10000000) != 0 /* is-active abs(NV2Real) */ && valueNodeValue_ instanceof NV2Real) {
    ...
    private Object executeAndSpecialize(Object valueNodeValue) {
        ...
        try {
            ...
            if (((exclude & 0b1)) == 0 /* is-not-excluded abs(Object, NV1IntLibrary) */) {
                int count3_ = 0;
                Abs2Data s3_ = this.abs2_cache;
                if ((state & 0b100) != 0 /* is-active abs(Object, NV1IntLibrary) */) {
                    while (s3_ != null) {
            ...
            if (((exclude & 0b10)) == 0 /* is-not-excluded abs(Object, NV1RealLibrary) */) {
                int count5_ = 0;
                Abs4Data s5_ = this.abs4_cache;
                if ((state & 0b10000) != 0 /* is-active abs(Object, NV1RealLibrary) */) {
                    while (s5_ != null) {
                ...
                if (s5_ == null) {
                    {
                        ...
                        if ((arrays__1.isArray(valueNodeValue)) && count5_ < (3)) {
                            ...
                            this.abs4_cache = s5_;
                            this.state_ = state = state | 0b10000 /* add-active abs(Object, NV1RealLibrary) */;
                        }
                    }
                }
                if (s5_ != null) {
                    ...
                    try {
                        {
                            ...
                            if ((abs5_arrays__.isArray(valueNodeValue))) {
                                ...
                                state = state & 0xffffffef /* remove-active abs(Object, NV1RealLibrary) */;
                                this.state_ = state = state | 0b100000 /* add-active abs(Object, NV1RealLibrary) */;
                                lock.unlock();
                                hasLock = false;
            ...
            if (valueNodeValue instanceof NV2Int) {
                ...
                this.state_ = state = state | 0b1000000 /* add-active abs(NV2Int) */;
                lock.unlock();
                hasLock = false;
                return abs(valueNodeValue_);
            }
            if (valueNodeValue instanceof NV2Real) {
                ...
                this.state_ = state = state | 0b10000000 /* add-active abs(NV2Real) */;
                lock.unlock();
                hasLock = false;
                return abs(valueNodeValue_);
            }
